import { c as createLucideIcon, j as jsxRuntimeExports, R as Root$1, C as Content, a as cn, b as Close, X, T as Title, P as Portal, O as Overlay, r as reactExports, d as Primitive, u as useCart, m as motion, B as Button, S as Separator } from "./index-DuA-5N4r.js";
/**
...
function CheckoutModal({ open, onClose }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: (v) => !v && handleClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    DialogContent,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "font-display text-gray-900 text-xl", children: step === "done" ? "Order Confirmed! 🥭" : step === "payment" ? "Choose Payment Method" : "Complete Your Order" }) }),
        step === "done" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-gray-900 text-2xl font-bold", children: "Thank You!" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: "Your order has been sent to WhatsApp. We'll confirm shortly." }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-xl p-4 border border-border", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 uppercase tracking-wider mb-1", children: "Order Number" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-gray-900 text-lg", children: orderNumber })
              ] }),
          ...
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-xl p-4 border border-border space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-gray-900 text-sm mb-2", children: "Order Summary" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between font-bold text-gray-900", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-gray-900", children: "Select Payment Method" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: PAYMENT_OPTIONS.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-gray-900", children: opt.label })
                  ]
                },
                opt.id
              )) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-orange-50 border border-orange-200 rounded-xl p-4 space-y-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("ol", { className: "text-xs text-gray-700 space-y-1 list-decimal list-inside", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs text-gray-500", children: "Clicking above opens WhatsApp with your order details pre-filled." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
        ...
        step === "form" && /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleFormSubmit, className: "space-y-4", noValidate: true, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-xl p-4 border border-border space-y-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500", children: "Delivery" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: delivery === 0 ? "text-green-600 font-medium" : "font-medium",
